...
import EmptyGardenWizard from '../components/EmptyGardenWizard';
...
function LandingPage({ onLogout, userEmail }) {
  ...
  const navbarLinks = [
    ...
    { text: 'EMPTY GARDEN', action: () => setShowEmptyGardenWizard(true) },
              ...
              >
                <div className="cta-buttons">
                  <Button 
                    ...
                    className="create-garden-cta primary"
                  >
                    CREATE GARDEN
                  </Button>
                  <Button 
                    onClick={() => setShowEmptyGardenWizard(true)}
                    className="create-garden-cta secondary"
                  >
                    DESIGN EMPTY GARDEN
                  </Button>
                </div>
